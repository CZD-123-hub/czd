...
const menuItems = [
  ...
  { path: '/graph', icon: Share, title: '知识图谱' },
  { path: '/path', icon: Guide, title: '学习路径' },
  { path: '/snippets', icon: DocumentCopy, title: '代码片段' },
  { path: '/documents', icon: Notebook, title: '知识文档' },
  { path: '/dashboard', icon: DataAnalysis, title: '学习看板' },
]
...
<template>
  <el-container class="app-layout">
    <el-aside :width="isCollapsed ? '76px' : '240px'" class="app-sidebar">
    ...
    <el-container class="main-container">
      <el-header class="app-header">
        <div class="header-left">
          <p class="page-eyebrow">Learning Studio</p>
